...
public class PhysicalExamination {
	...
	public static void main(String[] args) {
		...
		PhyscData[] x = {
				...
				new PhyscData("채치수", 193, 0.2),
				new PhyscData("정대만", 183, 0.3),
				new PhyscData("권준호", 178, 0.4),
				new PhyscData("송태섭", 167, 0.5),
				new PhyscData("강백호", 189, 0.6),
				new PhyscData("서태웅", 187, 0.7),
		};
		...
		for(int i=0; i<VMAX; i++) {
			System.out.printf("%3.1f ~ %3.1f : %2d명\n", i/10.0 , (i+1)/10.0, vdist[i]);
		}
